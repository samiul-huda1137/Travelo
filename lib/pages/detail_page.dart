                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          IconButton(onPressed: (){}, icon: Icon(Icons.keyboard_control, color: Colors.white,))
                        ],
                      ),
                    )
                ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              LargeText(text: detail.places.name, color: Colors.black.withOpacity(0.8),),
                              LargeText(text: "\$"+detail.places.price.toString(), color: AppColors.mainColor,),
                            ],
                          ),
                          SizedBox(height: 10,),
                          Row(
